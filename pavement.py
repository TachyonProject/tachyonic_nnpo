...
def run(args):
    ...
    from tachyonic.nnpo.main import main
...
def get_tasks():
    ...
    from paver.tasks import environment as paver_environment
    for task_env in paver_environment.get_tasks():
        print(task_env.shortname)
