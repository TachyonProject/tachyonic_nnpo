...
name = str('tachyonic.nnpo')
sep = name.split('.')
namespace = sep[0]
module = sep[1]

## Constants
CODE_DIRECTORY = '%s/%s' % (namespace, module)
...
metadata = imp.load_source(
    'metadata', os.path.join(namespace, module, 'metadata.py'))
...
setup_dict = dict(
    ...
    entry_points={
        # 'console_scripts': [
        #     'tachyonic.nnpo_cli = tachyonic.nnpo.main:entry_point'
        # ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'tachyonic.nnpo_gui = tachyonic.nnpo.gui:entry_point'
        # ]
    }
)
